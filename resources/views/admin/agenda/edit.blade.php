        ...
        <form action="{{ route('admin.agenda.update', $agenda) }}" method="POST">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nama_agenda') is-invalid @enderror" 
                               id="nama_agenda" name="nama_agenda" value="{{ old('nama_agenda', $agenda->nama_agenda) }}" required>
                        @error('nama_agenda')
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control @error('tanggal_agenda') is-invalid @enderror"
                               id="tanggal_agenda" name="tanggal_agenda" value="{{ old('tanggal_agenda', $agenda->tanggal_agenda) }}" required>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('waktu') is-invalid @enderror"
                               id="waktu" name="waktu" value="{{ old('waktu', $agenda->waktu) }}" placeholder="Contoh: 08.30 WIB - Selesai" required>
                        @error('waktu')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="form-group">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="link_active" name="link_active" value="1" {{ old('link_active', $agenda->link_active) ? 'checked' : '' }}>
